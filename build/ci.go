...
import (
	...
	"github.com/rink-labs/libevm/crypto/signify"
	"github.com/rink-labs/libevm/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/rink-labs/libevm/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/rink-labs/libevm/internal/version.gitDate="+env.Date)
	}
